    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to=pathlib.PureWindowsPath('C:/_b.VV/commercial-projects/TTSTempering/media/images/articles'))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('html_title_override', models.CharField(blank=True, help_text='По умолчанию для HTML Title используется Name.', max_length=128, verbose_name='HTML Title (переопределение)')),
                ('html_description', models.CharField(blank=True, verbose_name='HTML Description')),
                ('image', models.ImageField(upload_to=pathlib.PureWindowsPath('C:/_b.VV/commercial-projects/TTSTempering/media/images/services'), verbose_name='Изображение')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to=pathlib.PureWindowsPath('C:/_b.VV/commercial-projects/TTSTempering/media/images/categories'), verbose_name='Изображение')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('html_description', models.CharField(blank=True, verbose_name='HTML Description')),
                ('description', tinymce.models.HTMLField(verbose_name='Описание')),
                ('blueprint_image', models.ImageField(blank=True, upload_to=pathlib.PureWindowsPath('C:/_b.VV/commercial-projects/TTSTempering/media/images/products/blueprints'), verbose_name='Чертёж')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(upload_to=pathlib.PureWindowsPath('C:/_b.VV/commercial-projects/TTSTempering/media/images/products/photos'), verbose_name='Изображение')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(upload_to=pathlib.PureWindowsPath('C:/_b.VV/commercial-projects/TTSTempering/media/images/services/examples'), verbose_name='Изображение')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', tinymce.models.HTMLField(verbose_name='Описание')),
                ('image', models.ImageField(max_length=200, upload_to=pathlib.PureWindowsPath('C:/_b.VV/commercial-projects/TTSTempering/media/images/services/advantages'), verbose_name='Изображение')),
